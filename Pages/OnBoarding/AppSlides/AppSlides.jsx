...
export const AppSlides = ({navigation}) => {
  ...
  pages={[
    ...
    />
      ...
      title: 'Yoga at Home with Expert Teachers ',
      subtitle: '',
    ...
    },
    {
      ...
      image:(
        <View>
           <LottieView
         style={styles.lottie}
         source={require('../../../assets/Animations/Animation - 1706009630102.json')}
      autoPlay loop
    />
      ...
      title: 'The Easy Start & Stick With It Plan',
      subtitle: '',
   ...
   source={require('../../../assets/Animations/Animation - 1694769001609.json')}
    ...
    />
      ...
      title: "Elevate Your Practice with Yoga's Best",
      subtitle: '',
    },
